...
public class SearchResultActivity extends AppCompatActivity {
    ...
    private void displayListView() {
        ...
        for (NCMBObject obj : Utility.userInfoDataList) {
            UserListItem userItem = new UserListItem(obj.getString("DisplayName"), obj.getString("SNSUserName"), obj.getString("CategoryRole"), obj.getString("ImaginationHope"), obj.getInt("SpinnerAgeInt"), obj.getInt("SpinnerSex"));
            userListItems.add(userItem);
        }

        final UserRecyclerViewAdapter adapter = new UserRecyclerViewAdapter(userListItems, getSupportFragmentManager(), SearchResultActivity.this);
